function BW = removeRegionBelowSegLine(pathX, pathY, imgPad, bandWidth) 
...
bottom = ones(1,size(imgPad,2))*size(imgPad,1);

BW = poly2mask([ysUp,fliplr(ysUp)], [xsUp,bottom], size(imgPad,1), size(imgPad,2));
